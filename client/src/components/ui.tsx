...
const STATUS_STYLES: Record<string, string> = {
  ...
  'For approval': 'bg-sky-100 text-sky-700 ring-1 ring-sky-200/60',
  ...
  Online: 'bg-sky-100 text-sky-700 ring-1 ring-sky-200/60',
  authenticating: 'bg-amber-100 text-amber-800 ring-1 ring-amber-200/60',
  ...
  // Job orders
  open: 'bg-sky-100 text-sky-700 ring-1 ring-sky-200/60',
  Open: 'bg-sky-100 text-sky-700 ring-1 ring-sky-200/60',
  in_progress: 'bg-amber-100 text-amber-800 ring-1 ring-amber-200/60',
  'In Progress': 'bg-amber-100 text-amber-800 ring-1 ring-amber-200/60',
  follow_up: 'bg-violet-100 text-violet-700 ring-1 ring-violet-200/60',
  'Follow-up': 'bg-violet-100 text-violet-700 ring-1 ring-violet-200/60',
...
export function Toast({ message }: { message: string }) {
  if (!message) return null;
  return (
    // --bottom-nav-h is 0px on the web, so this is unchanged there; in the
    // native app it lifts the toast clear of the fixed bottom nav instead of
    // floating on top of the menu.
    <div className="toast-dock fixed right-4 left-4 sm:left-auto z-[2000] sm:max-w-sm animate-fade-in-up">
