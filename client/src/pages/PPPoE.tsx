        ...
        >
          <div className="space-y-4 text-sm text-slate-600">
            ...
            <p>
              ...
              Recheck does <b>not</b> send expiry-reminder or non-payment SMS/email. Subscribers are notified only from
              Notification settings (days-before reminder) and when an account is disabled after grace.
            </p>
