        ...
        <Card title="Reminder & Auto-disable Settings">
          <div className="space-y-4">
            ...
            <Row
              ...
              desc="Disable when overdue past the grace period (from due date). SMS/email are sent only for expiry reminders (above) and when the account is disabled — not when it first moves to the non-payment profile during grace/recheck."
            >
