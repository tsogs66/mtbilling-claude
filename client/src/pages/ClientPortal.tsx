        ...
        <form onSubmit={login} className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 space-y-4">
          <div className="flex flex-col items-center gap-3 mb-2">
            ...
            <div className="text-center">
              <h1 className="text-xl font-bold text-slate-800">Subscriber Portal</h1>
              <p className="text-sm text-slate-500">{PRODUCT_TITLE}</p>
            </div>
          </div>
          ...
          <p className="text-xs text-slate-400 text-center">Ask your ISP for portal access (account + PIN).</p>
        </form>
      </div>
    );
  }
